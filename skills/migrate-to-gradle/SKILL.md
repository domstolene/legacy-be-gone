...
6. Update any Dockerfiles to use gradle commands instead of maven commands. For example, update Dockerfile to use `./gradlew buildFatJar` instead of `mvn clean install`.
